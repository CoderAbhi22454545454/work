...
function Hero() {
  return (
    <>
      ...
      >
        <p className="text-xl mb-5">Hello There,  Nice to see you 😊 </p>
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl sm:text-3xl md:text-5xl lg:text-6xl tracking-tighter mb-10 font-bold heroShinyBg">
          Transforming Digital Dreams into Reality with Stunning Frontend
          Interfaces
          {/* 
